...
public class MarqueFilterController implements Initializable {
    @FXML
    ...
    public List<Voiture> marqueSearchF() throws SQLException {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                alert.setContentText("Cette marque n'existe pas!");
                alert.showAndWait();}
